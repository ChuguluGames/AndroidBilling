...
PhoneGap.addConstructor(function() {
  ...
  exports.Application = (function() {
    ...
    Application.prototype.waitForDocumentReady = function() {
      var _this = this;
    ...
    Application.prototype.initialize = function() {
      return window.plugins.Store.initialize(function() {
        return window.plugins.Store.requestPurchase("android.test.purchased", function(status) {
          return console.log("purchaseddddddddddddd " + status);
        });
      });
    };
